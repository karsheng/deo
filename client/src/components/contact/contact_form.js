            ...
            <Paper style={style.paper} zDepth={3}>
                <div className="row">
                    ...
                    <div className="col-xs-12 col-md-6">
                        ...
                        <img
                            style={style.social}
                            src="https://image.freepik.com/free-icon/facebook-logo-button_318-84980.jpg"
                        />
                        <img
                            style={style.social}
                            src="https://image.freepik.com/free-icon/instagram-logo_318-84939.jpg"
                        />
                        <img
                            style={style.social}
                            src="https://image.freepik.com/free-icon/twitter-logo-button_318-85053.jpg"
                        />
                        <img
                            style={style.social}
                            src="https://image.freepik.com/free-icon/youtube-logo_318-76452.jpg"
                        />
                        <br />
                        <br />
                        <br />
