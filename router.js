...
const adminRequireSignin = passport.authenticate('admin-local', {
	session: false
});
...
module.exports = function(app) {
	...
	app.get(
		...
		requireAuth,
		UserController.getRegistrationInfo
	);
	app.post(
	...
	app.get(
		'/api/event/category/available/:event_id',
		requireAuth,
		UserController.getCategoriesAvailability
	);
	...
	app.post(
		...
		requireAuth,
		FakePaymentController.executeFakePayment
	);

	app.post(
		'/api/paypal/create-payment/:registration_id',
		requireAuth,
		PayPalPaymentController.createPayment
	);
	app.post(
		'/api/paypal/execute-payment/:registration_id',
		requireAuth,
		PayPalPaymentController.executePayment
	);
	...
	app.post(
		'/api/admin/associate',
		adminRequireAuth,
		AdminController.createAssociate
	);
	app.put(
		'/api/admin/associate/:associate_id',
		adminRequireAuth,
		AdminController.updateAssociate
	);
	app.delete(
		'/api/admin/associate/:associate_id',
		adminRequireAuth,
		AdminController.deleteAssociate
	);
